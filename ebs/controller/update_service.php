...
<?php  
	...
	$filter['id_service'] = $new_data['id_service'];

	$manager->update_common("tb_services",$new_data,$filter,NULL);
	...
	# Redirecionamento
	header("location: $project_index".$user->profile_page.".php?option=list_services&success=update_ok");
?>