<?php  
	...
	$filter['id_client'] = $_POST['filter'];

	# Excluindo os dados no banco
	$manager = new Manager();

	$manager->delete_common("tb_clients",$filter,NULL);
	...
	fwrite($archive, $user->name." deletou um Cliente");
	fwrite($archive, "\n");
	...
	# Redirecionamento
	header("location: $project_index".$user->profile_page.".php?option=list_clients&success=delete_ok");
?>